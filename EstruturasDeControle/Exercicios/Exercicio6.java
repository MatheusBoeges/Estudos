...
public class Exercicio6 {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.print("Sorteando um número entre 0 á 100...\n");
			...
			do {	
				...
				if (numero > numeroSorteado) {
					...
					System.out.printf("\nParabens! Você acertou o número faltando %d tentativas!\n\n", tentativas);
					break;
				}
			
					
		} while (tentativas != 0);
			System.out.println("Digite 0 para sair, ou qualquer outro núemro para continuar: ");
